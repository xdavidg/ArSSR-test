...
if __name__ == '__main__':
    ...
    filenames = [f for f in os.listdir(config['raw_data_path']) if f.endswith('.nii.gz')]
    ...
    for f in train_files:
        create_patches(
            input_path=os.path.join(config['raw_data_path'], f),
    ...
    print(f"- Training/Validation/Test split: {config['train_ratio']*100}%/{config['val_ratio']*100}%/{config['test_ratio']*100}%")
